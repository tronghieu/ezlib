...
test.describe("Authentication Flow E2E Tests", () => {
  ...
  test("1.3-E2E-002: Login page displays and validates email input", async ({
    page,
  }) => {
  ...
  test("1.3-E2E-003: Valid email submission shows loading state", async ({
    page,
  }) => {
  ...
  test("1.3-E2E-005: Middleware protects all dashboard routes", async ({
    page,
  }) => {
  ...
  test("1.3-E2E-006: Authentication callback handles valid tokens", async ({
    page,
    context,
  }) => {
    ...
    await page.goto(
      `/auth/callback?access_token=${mockToken}&refresh_token=${mockRefreshToken}&type=email`
    );
  ...
  test("1.3-E2E-007: Authentication callback handles errors gracefully", async ({
    page,
  }) => {
    ...
    await page.goto(
      `/auth/callback?access_token=${invalidToken}&error=invalid_token`
    );
  ...
  test("1.3-E2E-008: Logout functionality clears session", async ({
    page,
    context,
  }) => {
  ...
  test("1.3-E2E-009: Session persistence across page refreshes", async ({
    page,
  }) => {
  ...
  test("1.3-E2E-011: Authentication state synchronization", async ({
    page,
  }) => {
...
test.describe("Authentication Security Tests", () => {
  test("1.3-SEC-001: Direct API route access requires authentication", async ({
    request,
  }) => {
  ...
  test("1.3-SEC-002: Session validation prevents expired token access", async ({
    page,
  }) => {
  ...
  test("1.3-SEC-003: No authentication bypass through URL manipulation", async ({
    page,
  }) => {
