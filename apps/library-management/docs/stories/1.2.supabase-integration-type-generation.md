...
- src/lib/supabase/**tests**/admin.test.ts
- src/lib/supabase/**tests**/middleware.test.ts
- src/lib/supabase/**tests**/realtime.test.ts
- src/lib/supabase/**tests**/integration.test.ts
- src/lib/types/**tests**/type-helpers.test.ts
- src/lib/utils/**tests**/env-validation.test.ts
- src/lib/utils/**tests**/env-file-validation.test.ts
