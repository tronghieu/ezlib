...
class EnrichmentJob(BaseModel):
    ...
    min_quality_score: Optional[float] = Field(None, description="Minimum quality threshold")
    ...
    # Processing metrics
    processing_metrics: Optional[Dict[str, Any]] = Field(None, description="Processing performance metrics")
    
    # Data quality flags
    has_warnings: bool = Field(default=False, description="Whether quality warnings exist")
    requires_review: bool = Field(default=False, description="Whether manual review is required")
    suspicious_data_flags: List[str] = Field(default_factory=list, description="List of data quality concerns")
...
class BatchEnrichmentJob(BaseModel):
    ...
    min_quality_score: Optional[float] = Field(None)
    ...
    job_ids: List[str] = Field(default_factory=list, description="List of individual job IDs")
