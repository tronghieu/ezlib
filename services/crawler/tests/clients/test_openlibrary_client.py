...
class TestOpenLibraryClient:
    ...
    async def test_fetch_book_by_isbn_success(self, client, sample_openlibrary_response):
    ...
    async def test_fetch_book_by_isbn_not_found(self, client, empty_openlibrary_response):
