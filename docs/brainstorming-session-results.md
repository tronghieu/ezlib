...
- Peek preview: first paragraph of Sarah's review + availability chips (eBook • Audiobook • Print) + "Add to read" pill for instant formats
...
- Reading plan suggestion: "Finish in 10 days?" → [Yes] creates goal with daily pages/minutes
- Pre-enabled notifications: 3-day due date reminder + hold-ready alerts  
- Queue management: "You're #4 • ~1–2 weeks" with [Auto-borrow] toggle for holds
